...
const HomePage = () => {
  return (
    <div className="flex flex-col relative overflow-hidden">
      ...
      {/*The Vision*/}
      <div id="font-rem" className="pb-56 text-black pt-[150px] bg-gradient-to-r from-purple-500 via-blue-500 to-green-500 flex flex-col justify-center relative">
      ...
      <div className="select-none">
          <div className="min-h-screen pb-56 text-white pt-24 bg-black flex flex-col justify-center relative z-30 overflow-visible">
